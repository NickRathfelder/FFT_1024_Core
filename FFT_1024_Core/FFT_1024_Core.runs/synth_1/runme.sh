...
HD_PWD='C:/Users/ironb/Projects/FPGA/FFT_1024_Core/FFT_1024_Core/FFT_1024_Core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_1024_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_1024_core.tcl
